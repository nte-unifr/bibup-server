...
<div id="navigBarre">
	...
	<div id="nbRight">
		...
		{
			echo "<li><a href=\"index.php\">References</a></li>";
			echo "<li><a href=\"tuto/index.php\">Tutorial</a></li>";
			echo "<li><a href=\"faq.php\">FAQ</a></li>";
			echo "<li><a href=\"contact.php\">Contact</a></li>";
...
<div id="main">
	...
	<img src="images/logo_bibup_512x512.png" width="58" border="0" ><br /><br />
...
<!-- box menu2 -->
		...
		<div class="box001">
			...
			<div class="box001_content">
				<div align="left">
				Tell us what you think about BibUp : <a href="https://www.unifr.ch/survey/start/index.php?sid=95831&lang=en" title="Feedback" target="_blank">take our survey</a> !<br /><br />
				</div>
   			</div>
		</div>
